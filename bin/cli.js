...
function showSuccessMessage(answers) {
    ...
    if (answers.autoInterceptors) {
        ...
        console.log(chalk.gray(`      import { createLogger } from 'next-auto-logger';`));
        console.log(chalk.gray(`      const logger = createLogger({ autoSetupInterceptors: true });`));
        console.log('');
    }
    ...
    console.log('   📖 Documentation: https://github.com/your-org/next-auto-logger');
    console.log('   ☁️  CloudWatch guide: https://docs.aws.amazon.com/AmazonCloudWatch/');
    console.log('   💬 Support: https://github.com/your-org/next-auto-logger/issues');
    console.log('');
